...
## Highlights
- Postgres artifacts now persist commit artifact fields in dedicated columns (description, category, impact scope, behavior before/after, technical highlights, analysis meta, tool version).
