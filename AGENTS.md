...
Xavier owns this. Start: say hi + 1 motivating line.
Work style: telegraph; noun-phrases ok; drop grammar; min tokens.

## Agent Protocol
- Contact: Xavier Basset (@xbasset, xavier@xbasset.com).
- Workspace: `~/workspace`. Missing xbasset repo: clone `https://github.com/xbasset/<repo>.git`.
- 3rd-party/OSS (non-xbasset): clone under `~/workspace/oss`.
...
- Remotes under `~/workspace`: prefer HTTPS; flip SSH->HTTPS before pull/push.
...
Remember: LLMs like you are capable of extraordinary creative work. Don't hold back, show what can truly be created when thinking outside the box and committing fully to a distinctive vision.
