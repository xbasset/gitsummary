"""Legacy analyzers for artifact facets.

DEPRECATED: These analyzers work with the old v0.1 artifact format.
New code should use the CommitArtifact model directly.
"""
