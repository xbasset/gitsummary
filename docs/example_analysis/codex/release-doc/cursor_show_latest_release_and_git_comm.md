# Show latest release and git commits
_Exported on 25/11/2025 at 9:13:47 CET from Cursor (2.1.32)_

---

**User**

look at the latest release from the tags and show me the git commits involved
...
Finding the latest release tag, then listing its commits.



Showing commits between the previous release and the latest:



Showing detailed commit messages for the release:



Getting a summary count:



## Latest Release: `rust-v0.64.0-alpha.5`
...
1. **832fa24b9** - Michael Bolin, 3 days ago : Release 0.64.0-alpha.5
2. **529eb4ff2** - zhao-oai, 3 days ago : move execpolicy quickstart (#7127)
3. **c6f68c9df** - Michael Bolin, 3 days ago : feat: declare server capability in shell-tool-mcp (#7112)
4. **af63e6ecc** - Michael Bolin, 3 days ago : fix: start publishing @openai/codex-shell-tool-mcp to npm (#7123)
5. **87b211709** - zhao-oai, 3 days ago : bypass sandbox for policy approved commands (#7110)
6. **67975ed33** - Michael Bolin, 3 days ago : refactor: inline sandbox type lookup in process_exec_tool_call (#7122)
7. **7561a6aaf** - Jeremy Rose, 3 days ago : support MCP elicitations (#6947)
8. **3ea33a061** - Josh McKinney, 3 days ago : fix(tui): Fail when stdin is not a terminal (#6382)
9. **e8ef6d3c1** - Michael Bolin, 3 days ago : feat: support login as an option on shell-tool-mcp (#7120)
10. **e52cc38df** - pakrym-oai, 3 days ago : Use use_model (#7121)
11. **3bdcbc729** - iceweasel-oai, 3 days ago : Windows: flag some invocations that launch browsers/URLs as dangerous (#7111)
12. **a0434bbdb** - Owen Lin, 3 days ago : [app-server] doc: approvals (#7105)
13. **d5f661c91** - Ahmed Ibrahim, 3 days ago : enable unified exec for experiments (#7118)
14. **8ecaad948** - Ahmed Ibrahim, 3 days ago : feat: Add exp model to experiment with the tools (#7115)
15. **aa4e0d823** - Owen Lin, 4 days ago : [app-server] feat: expose gitInfo/cwd/etc. on Thread (#7060)
16. **0e051644a** - Dylan Hurd, 4 days ago : fix(scripts) next_minor_version should reset patch number (#7050)
17. **40d14c075** - Michael Bolin, 4 days ago : fix: clear out duplicate entries for `bash` in the GitHub release (#7103)
18. **af6566656** - jif-oai, 4 days ago : chore: drop model_max_output_tokens (#7100)
19. **2ae1f81d8** - Owen Lin, 4 days ago : [app-server] feat: add Declined status for command exec (#7101)
20. **d363a0968** - Michael Bolin, 4 days ago : feat: codex-shell-tool-mcp (#7005)
21. **bce030ddb** - jif-oai, 4 days ago : Revert "fix: read `max_output_tokens` param from config" (#7088)
22. **f4af6e389** - iceweasel-oai, 4 days ago : Windows Sandbox: support network_access and exclude_tmpdir_env_var (#7030)
23. **b315b22f7** - Eric Traut, 4 days ago : Fixed the deduplicator github action (#7070)
24. **c9e149fd5** - Yorling, 4 days ago : fix: read `max_output_tokens` param from config (#4139)
25. **bacdc004b** - Eric Traut, 4 days ago : Fixed two tests that can fail in some environments that have global git rewrite rules (#7068)
26. **ab5972d44** - pakrym-oai, 4 days ago : Support all types of search actions (#7061)
27. **767b66f40** - pakrym-oai, 4 days ago : Migrate coverage to shell_command (#7042)
28. **830ab4ce2** - pakrym-oai, 4 days ago : Support full powershell paths in is_safe_command (#7055)
29. **3f73e2c89** - Dylan Hurd, 4 days ago : fix(app-server) remove www warning (#7046)
30. **1822ffe87** - Dylan Hurd, 4 days ago : feat(tui): default reasoning selection to medium (#7040)
31. **7e2165f39** - Celia Chen, 4 days ago : [app-server] update doc with codex error info (#6941)
32. **8e5f38c0f** - Michael Bolin, 4 days ago : feat: waiting for an elicitation should not count against a shell tool timeout (#6973)
33. **1388e9967** - Ahmed Ibrahim, 4 days ago : fix flaky `tool_call_output_exceeds_limit_truncated_chars_limit` (#7043)
34. **f56d1dc8f** - Michael Bolin, 4 days ago : feat: update process_exec_tool_call() to take a cancellation token (#6972)
35. **9be310041** - Ahmed Ibrahim, 4 days ago : migrate `collect_tool_identifiers_for_model` to `test_codex` (#7041)
36. **0fbcdd77c** - Xiao-Yong Jin, 4 days ago : core: make shell behavior portable on FreeBSD (#7039)
37. **9bce05038** - Celia Chen, 4 days ago : [app-server & core] introduce new codex error code and v2 app-server error events (#6938)
38. **3f92ad419** - iceweasel-oai, 4 days ago : add deny ACEs for world writable dirs (#7022)
39. **54ee302a0** - Ahmed Ibrahim, 4 days ago : Attempt to fix `unified_exec_formats_large_output_summary` flakiness  (#7029)
40. **44fa06ae3** - Ahmed Ibrahim, 4 days ago : fix flaky test: `approval_matrix_covers_all_modes` (#7028)
41. **856f97f44** - pakrym-oai, 4 days ago : Delete shell_command feature (#7024)
42. **fe7a3f0c2** - zhao-oai, 4 days ago : execpolicycheck command in codex cli (#7012)
43. **c30ca0d5b** - zhao-oai, 4 days ago : increasing user shell timeout to 1 hour (#7025)
44. **a8a6cbdd1** - Weiller Carvalho, 4 days ago : fix: route feedback issue links by category (#6840)
45. **e4257f432** - Dmitri Khokhlov, 4 days ago : codex-exec: allow resume --last to read prompt #6717 (#6719)
46. **2c793083f** - Jeremy Rose, 4 days ago : tui: centralize markdown styling and make inline code cyan (#7023)
47. **e150798ba** - Lionel Cheng, 4 days ago : Bumped number of fuzzy search results from 8 to 20 (#7013)
48. **33a6cc66a** - Kyuheon Kim, 4 days ago : fix(cli): correct mcp add usage order (#6827)
49. **52d0ec4cd** - pakrym-oai, 5 days ago : Delete tiktoken-rs (#7018)
50. **397279d46** - LIHUA, 5 days ago : Fix: Improve text encoding for shell output in VSCode preview (#6178) (#6182)
51. **30ca89424** - pakrym-oai, 5 days ago : Always fallback to real shell (#6953)
52. **d909048a8** - Eric Traut, 5 days ago : Added feature switch to disable animations in TUI (#6870)
53. **888c6dd9e** - jif-oai, 5 days ago : fix: command formatting for user commands (#7002)
54. **b5dd18906** - hanson-openai, 5 days ago : Allow unified_exec to early exit (if the process terminates before yield_time_ms) (#6867)
55. **54e6e4ac3** - Michael Bolin, 5 days ago : fix: when displaying execv, show file instead of arg0 (#6966)
56. **e8af41de8** - Michael Bolin, 5 days ago : fix: clean up elicitation used by exec-server (#6958)
57. **d6c30ed25** - Owen Lin, 5 days ago : [app-server] feat: v2 apply_patch approval flow  (#6760)
58. **fb9849e1e** - zhao-oai, 5 days ago : migrating execpolicy -> execpolicy-legacy and execpolicy2 -> execpolicy (#6956)
59. **72a1453ac** - Celia Chen, 5 days ago : Revert "[core] add optional status_code to error events (#6865)" (#6955)
60. **6d67b8b28** - Ahmed Ibrahim, 5 days ago : stop model migration screen after first time. (#6954)

### Highlights:
- **MCP support**: shell-tool-mcp, MCP elicitations, login option
- **Exec policy**: execpolicy migration, policy-approved command bypass, execpolicycheck CLI command
- **Windows sandbox**: network access support, browser/URL flagging
- **App-server**: v2 apply_patch approval flow, declined status, gitInfo/cwd exposure
- **TUI**: markdown styling, reasoning selection default, animation toggle
- **Unified exec**: enabled for experiments, early exit support
- **Bug fixes**: flaky tests, encoding, command formatting, timeout handling

All commits are from the last 3–5 days, indicating active development.

---

**User**

from a release perspective, i would like to create a one page markdown document with the following sections:
  - 	User-visible impact (Risk/Breaking Changes)
  - 	Before/After behavior
  - 	Implementation decisions
  -    Other (subdivised as needed)

I want to ground the information on an analysis of the code itself, based on the changes provided by each commit.
Run deep code analysis to collect the data you need and surface it in the document with references to the commits as sources of informations in the document
...
Analyzing commits to draft release notes. Examining key commits and their code changes.



Examining specific commits to understand the code changes:



Examining more commits to understand the full scope:



Reviewing a few more commits, then drafting the release notes:



Creating the release notes document:
...
Created the release notes document. Verifying it's complete:



Created a release notes document for `rust-v0.64.0-alpha.5` based on code analysis of the 60 commits.

## Document Structure

The document (`RELEASE_NOTES_v0.64.0-alpha.5.md`) includes:

### 1. **User-Visible Impact (Risk/Breaking Changes)**
   - ExecPolicy sandbox bypass behavior change (medium risk)
   - ExecPolicy package migration (low risk)
   - Windows dangerous command detection (medium risk)
   - App-Server API V2 new status types (low risk)

### 2. **Before/After Behavior**
   - ExecPolicy sandbox bypass: how commands execute differently
   - MCP elicitations timeout handling: improved user interaction timing
   - Windows sandbox network access: new configuration options
   - App-Server V2 apply patch flow: new event ordering
   - TUI reasoning selection: UX improvements

### 3. **Implementation Decisions**
   - Architecture decisions with rationale
   - Code references showing the implementation
   - Trade-offs and design choices explained
...
- Commit references (e.g., `87b211709`)
- Code references with line numbers
- Impact analysis
- Before/after comparisons where applicable

The document is ready for review and can be used as official release documentation.
