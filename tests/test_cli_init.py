...
def test_init_writes_workflow(tmp_path: Path, monkeypatch) -> None:
    ...
    assert "git fetch origin refs/notes/intent:refs/notes/intent" in workflow
    assert "gitsummary ci release-notes" in workflow
